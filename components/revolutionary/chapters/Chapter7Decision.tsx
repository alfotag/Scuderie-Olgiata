      ...
      <AnimatePresence mode="wait">
        {!isRevealed && !isFormSubmitted ? (
          ...
          <motion.div
            ...
            animate={{ opacity: 1 }}
            exit={{ opacity: 0 }}
            className="relative z-10 text-center px-4 sm:px-6 md:px-8 max-w-3xl mx-auto py-8 sm:py-12 md:py-16 overflow-hidden"
          >
            {/* Top Decorative Line */}
            <motion.div
              initial={{ scaleX: 0 }}
            ...
            <motion.div
              ...
              className="max-w-xl mx-auto space-y-3 sm:space-y-4 text-xs sm:text-sm text-white/70 leading-relaxed font-light mb-10 sm:mb-12 px-2"
            >
              ...
              <p className="text-amber-400/80 font-normal text-sm sm:text-base pb-2">
